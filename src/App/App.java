...
public class App {
  ...
  /**
   * Main Method
   * Cette method creer l'objet shared et donne sa reference a tout les objets qui en auront besoins
   * Elle definie les parametres du jeu (avance, trois joueur, plateauLibre)
   * @param args
   * @throws Exception
   */
